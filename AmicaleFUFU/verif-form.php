...
if (isset($terme))
{
 ...
 $select_terme = $bdd->prepare("SELECT titre, preparation FROM recette WHERE titre LIKE ? OR preparation LIKE ?");
...
<html>
 ...
 <body>
  ...
  {
   echo "<div><h2>".$terme_trouve['titre']."</h2><p> ".$terme_trouve['preparation']."</p>";
  }
